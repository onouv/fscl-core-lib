...
public class FsclEntityIdFormat {
    ...
    @Builder
    private FsclEntityIdFormat(String project, String prefix, String separator, String postfix)
        ...
        Pattern prefixPattern = Pattern.compile(PREFIX_REQEXP);
    ...
    public void validate(FsclEntityId dto) throws ProjectCodeException, EntityCodeException {
    ...
    private static final String PREFIX_REQEXP = "\\W{1,4}";
